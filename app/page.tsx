...
const MONDOU: readonly { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "はい。会場に着く前に一度この端末でひらいておけば、次からは電波がなくても開けます（初回だけ通信が要ります）。記帳も通信なしで動き、端末に保存されます。ただしブラウザのデータを消すと控えも消えるので、前日など直前にもう一度ひらいておくと確実です。控えが取れているかは記帳画面のいちばん下に出ます。",
  },
  {
    q: "当日いちばん確実に開くには",
    a: "記帳画面をブラウザで開き、共有・メニューから［ホーム画面に追加］してください。一突きで開けるうえ、控えが端末に長く残ります。追加したあとに一度起動しておくと万全です。",
  },
];
          ...
          <section className="tojitsu" aria-labelledby="tojitsu-midashi">
            <div>
              ...
              <p className="sai" style={{ marginTop: "var(--ma-1)" }}>
                記帳は端末に自動保存。会場に着く前に一度ひらいておけば、電波がなくても開けます。この帳面の頒価とつながり、当日の損益も出ます。
              </p>
